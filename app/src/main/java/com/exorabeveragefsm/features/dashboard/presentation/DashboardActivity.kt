...
import com.exorabeveragefsm.*
import com.exorabeveragefsm.R
import com.exorabeveragefsm.app.*
import com.exorabeveragefsm.app.NewFileUtils.browseDocuments
import com.exorabeveragefsm.app.NewFileUtils.getExtension
import com.exorabeveragefsm.app.domain.*
import com.exorabeveragefsm.app.types.DashboardType
import com.exorabeveragefsm.app.types.FragType
import com.exorabeveragefsm.app.types.TopBarConfig
import com.exorabeveragefsm.app.uiaction.DisplayAlert
import com.exorabeveragefsm.app.utils.*
import com.exorabeveragefsm.app.utils.AppUtils.Companion.isProfile
...
import com.exorabeveragefsm.features.NewQuotation.*
import com.exorabeveragefsm.features.NewQuotation.api.GetQuotRegProvider
import com.exorabeveragefsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.exorabeveragefsm.features.SearchLocation.SearchLocationFragment
import com.exorabeveragefsm.features.SearchLocation.locationInfoModel
import com.exorabeveragefsm.features.TA.ViewAllTAListFragment
import com.exorabeveragefsm.features.achievement.AchievementFragment
import com.exorabeveragefsm.features.activities.presentation.*
import com.exorabeveragefsm.features.addAttendence.*
import com.exorabeveragefsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.exorabeveragefsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.exorabeveragefsm.features.addAttendence.model.GetReportToFCMResponse
import com.exorabeveragefsm.features.addAttendence.model.GetReportToResponse
import com.exorabeveragefsm.features.addAttendence.model.Leave_list_Response
import com.exorabeveragefsm.features.addorder.presentation.AddOrderFragment
...
import com.exorabeveragefsm.features.addshop.presentation.AddShopFragment
import com.exorabeveragefsm.features.addshop.presentation.OTPVerificationDialog
import com.exorabeveragefsm.features.addshop.presentation.ScanImageFragment
import com.exorabeveragefsm.features.addshop.presentation.ShowCardDetailsDialog
import com.exorabeveragefsm.features.alarm.model.AlarmData
import com.exorabeveragefsm.features.alarm.presetation.AttendanceReportFragment
import com.exorabeveragefsm.features.alarm.presetation.PerformanceReportFragment
import com.exorabeveragefsm.features.alarm.presetation.VisitReportDetailsFragment
import com.exorabeveragefsm.features.alarm.presetation.VisitReportFragment
import com.exorabeveragefsm.features.attendance.AttendanceFragment
import com.exorabeveragefsm.features.attendance.api.AttendanceRepositoryProvider
...
import com.exorabeveragefsm.features.averageshop.presentation.AverageShopFragment
import com.exorabeveragefsm.features.avgorder.presentation.AverageOrderFragment
import com.exorabeveragefsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.exorabeveragefsm.features.beatCustom.TeamBeatListFragment
import com.exorabeveragefsm.features.billing.presentation.AddBillingFragment
import com.exorabeveragefsm.features.billing.presentation.BillingDetailsFragment
import com.exorabeveragefsm.features.billing.presentation.BillingListFragment
import com.exorabeveragefsm.features.changepassword.presentation.ChangePasswordDialog
import com.exorabeveragefsm.features.chat.model.ChatListDataModel
import com.exorabeveragefsm.features.chat.model.ChatUserDataModel
import com.exorabeveragefsm.features.chat.model.GroupUserDataModel
import com.exorabeveragefsm.features.chat.presentation.*
import com.exorabeveragefsm.features.chatbot.presentation.ChatBotFragment
import com.exorabeveragefsm.features.chatbot.presentation.ChatBotShopListFragment
import com.exorabeveragefsm.features.chatbot.presentation.ReportsFragment
import com.exorabeveragefsm.features.chatbot.presentation.SelectLanguageDialog
import com.exorabeveragefsm.features.commondialog.presentation.CommonDialog
import com.exorabeveragefsm.features.commondialog.presentation.CommonDialogClickListener
import com.exorabeveragefsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.exorabeveragefsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.exorabeveragefsm.features.commondialogsinglebtn.OnDialogClickListener
import com.exorabeveragefsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.exorabeveragefsm.features.dailyPlan.prsentation.AllShopListFragment
import com.exorabeveragefsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.exorabeveragefsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.exorabeveragefsm.features.damageProduct.ShopDamageProductListFrag
import com.exorabeveragefsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.exorabeveragefsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.exorabeveragefsm.features.dashboard.presentation.model.ContentListResponseModel
import com.exorabeveragefsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.exorabeveragefsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.exorabeveragefsm.features.device_info.presentation.DeviceInfoListFragment
import com.exorabeveragefsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.exorabeveragefsm.features.document.DocumentRepoFeatureNewFragment
import com.exorabeveragefsm.features.document.presentation.DocumentListFragment
import com.exorabeveragefsm.features.document.presentation.DocumentTypeListFragment
import com.exorabeveragefsm.features.document.presentation.OpenFileWebViewFragment
import com.exorabeveragefsm.features.dymanicSection.presentation.AddDynamicFragment
import com.exorabeveragefsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.exorabeveragefsm.features.dymanicSection.presentation.DynamicListFragment
import com.exorabeveragefsm.features.dymanicSection.presentation.EditDynamicFragment
import com.exorabeveragefsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.exorabeveragefsm.features.home.presentation.HomeFragment
import com.exorabeveragefsm.features.homelocation.presentation.HomeLocationFragment
import com.exorabeveragefsm.features.homelocation.presentation.HomeLocationMapFragment
import com.exorabeveragefsm.features.know_your_state.KnowYourStateFragment
import com.exorabeveragefsm.features.lead.LeadFrag
import com.exorabeveragefsm.features.lead.ViewLeadFrag
import com.exorabeveragefsm.features.leaveapplynew.LeaveHome
import com.exorabeveragefsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.exorabeveragefsm.features.localshops.LocalShopListFragment
import com.exorabeveragefsm.features.localshops.LocalShopListMapFragment
import com.exorabeveragefsm.features.localshops.NearByShopsMapFragment
import com.exorabeveragefsm.features.location.*
import com.exorabeveragefsm.features.location.api.LocationRepoProvider
import com.exorabeveragefsm.features.location.model.*
import com.exorabeveragefsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.exorabeveragefsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.exorabeveragefsm.features.login.ShopFeedbackEntity
import com.exorabeveragefsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.exorabeveragefsm.features.login.presentation.LoginActivity
import com.exorabeveragefsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.exorabeveragefsm.features.logoutsync.presentation.LogoutSyncFragment
import com.exorabeveragefsm.features.marketing.presentation.MarketingPagerFragment
import com.exorabeveragefsm.features.meetinglist.prsentation.MeetingListFragment
import com.exorabeveragefsm.features.member.MapViewForTeamFrag
import com.exorabeveragefsm.features.member.model.TeamLocDataModel
import com.exorabeveragefsm.features.member.model.TeamShopListDataModel
import com.exorabeveragefsm.features.member.presentation.*
import com.exorabeveragefsm.features.menuBeat.MenuBeatFrag
import com.exorabeveragefsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.exorabeveragefsm.features.micro_learning.presentation.MicroLearningListFragment
import com.exorabeveragefsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.exorabeveragefsm.features.myallowancerequest.MyallowanceRequestFragment
import com.exorabeveragefsm.features.myjobs.model.CustomerDataModel
import com.exorabeveragefsm.features.myjobs.presentation.*
import com.exorabeveragefsm.features.myorder.presentation.MyOrderListFragment
import com.exorabeveragefsm.features.myprofile.presentation.MyProfileFragment
import com.exorabeveragefsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.exorabeveragefsm.features.nearbyshops.model.ShopData
import com.exorabeveragefsm.features.nearbyshops.model.ShopListResponse
import com.exorabeveragefsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.exorabeveragefsm.features.nearbyshops.presentation.BeatListFragment
import com.exorabeveragefsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.exorabeveragefsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.exorabeveragefsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.exorabeveragefsm.features.newcollection.CollectionDetailsStatusFragment
import com.exorabeveragefsm.features.newcollection.CollectionShopListFragment
import com.exorabeveragefsm.features.newcollection.NewCollectionListFragment
import com.exorabeveragefsm.features.newcollectionreport.*
import com.exorabeveragefsm.features.notification.NotificationFragment
import com.exorabeveragefsm.features.orderList.NewDateWiseOrderListFragment
import com.exorabeveragefsm.features.orderList.NewOrderListFragment
import com.exorabeveragefsm.features.orderList.OrderListFragment
import com.exorabeveragefsm.features.orderdetail.presentation.OrderDetailFragment
import com.exorabeveragefsm.features.orderhistory.ActivityMapFragment
import com.exorabeveragefsm.features.orderhistory.OrderhistoryFragment
import com.exorabeveragefsm.features.orderhistory.TimeLineFragment
...
import com.exorabeveragefsm.features.pendinglocationinout.PendingOutLocationFrag
import com.exorabeveragefsm.features.performance.GpsStatusFragment
...
import com.exorabeveragefsm.features.returnsOrder.*
import com.exorabeveragefsm.features.settings.presentation.SettingsFragment
import com.exorabeveragefsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.exorabeveragefsm.features.shopdetail.presentation.*
import com.exorabeveragefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.exorabeveragefsm.features.stock.StockDetailsFragment
import com.exorabeveragefsm.features.stock.StockListFragment
import com.exorabeveragefsm.features.stockAddCurrentStock.AddShopStockFragment
import com.exorabeveragefsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.exorabeveragefsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.exorabeveragefsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.exorabeveragefsm.features.stockCompetetorStock.CompetetorStockFragment
import com.exorabeveragefsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.exorabeveragefsm.features.survey.SurveyFrag
import com.exorabeveragefsm.features.survey.SurveyViewDtlsFrag
import com.exorabeveragefsm.features.survey.SurveyViewFrag
import com.exorabeveragefsm.features.task.presentation.AddTaskFragment
...
import com.exorabeveragefsm.features.viewAllOrder.CartFragment
import com.exorabeveragefsm.features.viewAllOrder.OrderTypeListFragment
import com.exorabeveragefsm.features.viewAllOrder.ViewAllOrderListFragment
import com.exorabeveragefsm.features.viewAllOrder.ViewCartFragment
import com.exorabeveragefsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.exorabeveragefsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.exorabeveragefsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.exorabeveragefsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.exorabeveragefsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.exorabeveragefsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.exorabeveragefsm.features.viewPPDDStock.ViewOutstandingFragment
import com.exorabeveragefsm.features.viewPPDDStock.ViewPPDDListFragment
import com.exorabeveragefsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.exorabeveragefsm.features.viewPPDDStock.ViewStockFragment
import com.exorabeveragefsm.features.weather.presentation.WeatherFragment
import com.exorabeveragefsm.mappackage.MapActivity
import com.exorabeveragefsm.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xexorabeveragefsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.exorabeveragefsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
