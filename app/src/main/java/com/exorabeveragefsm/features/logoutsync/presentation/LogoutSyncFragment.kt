package com.exorabeveragefsm.features.logoutsync.presentation
...
import com.exorabeveragefsm.app.utils.Toaster
import com.exorabeveragefsm.base.BaseResponse
import com.exorabeveragefsm.base.presentation.BaseActivity
import com.exorabeveragefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.exorabeveragefsm.features.billing.api.AddBillingRepoProvider
import com.exorabeveragefsm.features.billing.model.AddBillingInputParamsModel
...
import com.exorabeveragefsm.features.dashboard.presentation.ReasonDialog
...
import com.exorabeveragefsm.features.document.model.AddEditDocumentInputParams
import com.exorabeveragefsm.features.document.model.DocumentAttachmentModel
...
import com.exorabeveragefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.exorabeveragefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.exorabeveragefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.exorabeveragefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.exorabeveragefsm.features.orderhistory.model.*
...
import com.exorabeveragefsm.features.quotation.model.AddQuotInputModel
import com.exorabeveragefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.exorabeveragefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.exorabeveragefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.exorabeveragefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.exorabeveragefsm.features.timesheet.model.AddTimeSheetInputModel
import com.exorabeveragefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.exorabeveragefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.exorabeveragefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.exorabeveragefsm.mappackage.SendBrod
import com.exorabeveragefsm.widgets.AppCustomTextView
import com.exorabeveragefsm.MonitorService
...
import com.exorabeveragefsm.features.addshop.presentation.ShopExtraContactReq
...
import com.exorabeveragefsm.features.login.model.GetConcurrentUserResponse
import com.exorabeveragefsm.features.performance.model.Gps_status_list
import com.exorabeveragefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.exorabeveragefsm.features.returnsOrder.ReturnProductList
import com.exorabeveragefsm.features.returnsOrder.ReturnRequest
import com.exorabeveragefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xexorabeveragefsmlogsample/log.zip").path);
